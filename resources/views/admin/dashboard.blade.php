    ...
    <div class="main-panel">
        ...
        <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2025 Apricorn Solutions <a
                        href="https://apricornsolutions.com/" target="_blank"> apricornsolutions.com </a> 
