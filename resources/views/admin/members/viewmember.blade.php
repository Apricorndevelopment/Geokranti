                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1 gap-md-2">
                                            <a href="{{ route('admin.editmember', $user->id) }}" class="btn btn-sm btn-outline-primary px-2">
                                                Edit
                                            </a>
                                            <a href="{{ route('admin.viewmemberdetails', $user->id) }}" class="btn btn-sm btn-outline-secondary px-2">
                                                View
                                            </a>
