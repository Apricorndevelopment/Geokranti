                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('user.profile.update') }}" enctype="multipart/form-data">
                        ...
                        <ul class="nav nav-tabs mb-4" id="profileTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="kyc-tab" data-bs-toggle="tab" data-bs-target="#kyc" type="button" role="tab">KYC</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="nominee-tab" data-bs-toggle="tab" data-bs-target="#nominee" type="button" role="tab">Nominee</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('pan_no') is-invalid @enderror"
                                            name="pan_no" value="{{ old('pan_no', $user->pan_no) }}">
                                        @error('pan_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" class="form-control @error('adhar_photo') is-invalid @enderror"
                                            name="adhar_photo" accept="image/*">
                                        @if($user->adhar_photo)
                                            <small class="text-muted">Current: <a href="{{ asset('storage/'.$user->adhar_photo) }}" target="_blank">View</a></small>
                                        @endif
                                        @error('adhar_photo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if($user->pan_photo)
                                            <small class="text-muted">Current: <a href="{{ asset('storage/'.$user->pan_photo) }}" target="_blank">View</a></small>
                                        @endif
                                        @error('pan_photo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="tab-pane fade" id="nominee" role="tabpanel">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('nom_name') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <input type="text" class="form-control @error('nom_relation') is-invalid @enderror"
                                            name="nom_relation" value="{{ old('nom_relation', $user->nom_relation) }}">
                                        @error('nom_relation')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="tab-pane fade" id="bank" role="tabpanel">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="file" class="form-control @error('passbook_photo') is-invalid @enderror"
                                            name="passbook_photo" accept="image/*">
                                        @if($user->passbook_photo)
                                            <small class="text-muted">Current: <a href="{{ asset('storage/'.$user->passbook_photo) }}" target="_blank">View</a></small>
                                        @endif
